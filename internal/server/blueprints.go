	...
	return []models.Blueprint{
		{
			...
			Env: []models.BlueprintEnv{
				{Key: "VERSION", Description: "Nginx image version", Default: "latest", Options: []string{"latest","alpine","1.25","1.24","1.23","1.22"}},
			},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				...
				{Key: "VERSION", Description: "Python image version", Default: "3.12-slim", Options: []string{"3.12-slim","3.11-slim","3.10-slim","3.9-slim"}},
			},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				...
				{Key: "VERSION", Description: "Node.js image version", Default: "22-alpine", Options: []string{"22-alpine","20-alpine","18-alpine","16-alpine"}},
			},
		...
		},
		{
			...
			DefaultPort: "5432",
			Env: []models.BlueprintEnv{
				{Key: "VERSION", Description: "PostgreSQL version", Default: "16", Options: []string{"16","15","14","13","12","11"}},
		...
		},
		{
			...
			DefaultPort: "3306",
			Env: []models.BlueprintEnv{
				{Key: "VERSION", Description: "MySQL version", Default: "8.4", Options: []string{"8.4","8.0","5.7"}},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				{Key: "VERSION", Description: "Redis image version", Default: "7-alpine", Options: []string{"7-alpine","7","6-alpine","6","5-alpine"}},
			},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				...
				{Key: "VERSION", Description: "Python image version", Default: "3.12-slim", Options: []string{"3.12-slim","3.11-slim","3.10-slim"}},
			},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				...
				{Key: "TYPE", Description: "Ядро: PAPER, VANILLA, SPIGOT, FORGE, FABRIC, BUKKIT, PURPUR, AIRPLANE, MAGMA, MOHIST", Default: "PAPER", Options: []string{"PAPER","VANILLA","SPIGOT","FORGE","FABRIC","BUKKIT","PURPUR","AIRPLANE","MAGMA","MOHIST"}},
				{Key: "VERSION", Description: "Версия Minecraft: 1.7.10, 1.12.2, 1.16.5, 1.20.4, LATEST", Default: "LATEST", Options: []string{"LATEST","1.21","1.20.4","1.20.1","1.19.4","1.18.2","1.17.1","1.16.5","1.15.2","1.14.4","1.12.2","1.7.10"}},
				{Key: "JAVA_VERSION", Description: "Версия Java: jdk8-jre, jdk11-jre, jdk16-jre, jdk17-jre, jdk21-jre, jdk22-jre, jdk23-jre, jdk24-jre, jdk25-jre", Default: "jdk21-jre", Options: []string{"jdk21-jre","jdk17-jre","jdk16-jre","jdk11-jre","jdk8-jre"}},
				...
				{Key: "DIFFICULTY", Description: "Сложность: easy, normal, hard, peaceful", Default: "easy", Options: []string{"easy","normal","hard","peaceful"}},
				{Key: "MODE", Description: "Режим: survival, creative, adventure, spectator", Default: "survival", Options: []string{"survival","creative","adventure","spectator"}},
				{Key: "MAX_PLAYERS", Description: "Макс. игроков", Default: "20"},
				{Key: "ENABLE_RCON", Description: "RCON доступ (true/false)", Default: "true", Options: []string{"true","false"}},
				{Key: "SEED", Description: "Сид мира (оставь пусто для random)", Default: ""},
				{Key: "LEVEL_TYPE", Description: "Тип мира: DEFAULT, FLAT, LARGEBIOMES, AMPLIFIED, CUSTOMIZED", Default: "DEFAULT", Options: []string{"DEFAULT","FLAT","LARGEBIOMES","AMPLIFIED","CUSTOMIZED"}},
				{Key: "SPAWN_PROTECTION", Description: "Радиус спавн-протекшн (0 = откл)", Default: "0"},
				{Key: "ONLINE_MODE", Description: "Проверка лицензии (true/false)", Default: "true", Options: []string{"true","false"}},
				{Key: "ALLOW_NETHER", Description: "Разрешить Незер", Default: "true", Options: []string{"true","false"}},
				{Key: "ALLOW_END", Description: "Разрешить Энд", Default: "true", Options: []string{"true","false"}},
				{Key: "PVP", Description: "PvP (true/false)", Default: "true", Options: []string{"true","false"}},
				{Key: "ENABLE_COMMAND_BLOCK", Description: "Командные блоки", Default: "false", Options: []string{"true","false"}},
				{Key: "WHITELIST", Description: "Вайтлист (true/false)", Default: "false", Options: []string{"true","false"}},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				...
				{Key: "TYPE", Description: "Ядро сервера", Default: "VANILLA", Options: []string{"PAPER","VANILLA","SPIGOT","FORGE","FABRIC","BUKKIT","PURPUR","AIRPLANE","MAGMA","MOHIST"}},
				{Key: "VERSION", Description: "Версия Minecraft (1.7.10 — LATEST)", Default: "LATEST", Options: []string{"LATEST","1.21","1.20.4","1.20.1","1.19.4","1.18.2","1.17.1","1.16.5","1.15.2","1.14.4","1.12.2","1.7.10"}},
				{Key: "JAVA_VERSION", Description: "Java: jdk8 до jdk25", Default: "jdk21-jre", Options: []string{"jdk21-jre","jdk17-jre","jdk16-jre","jdk11-jre","jdk8-jre"}},
				{Key: "MEMORY", Description: "RAM", Default: "2G"},
				{Key: "DIFFICULTY", Description: "Сложность", Default: "easy", Options: []string{"easy","normal","hard","peaceful"}},
				{Key: "MODE", Description: "Режим игры", Default: "survival", Options: []string{"survival","creative","adventure","spectator"}},
				{Key: "MAX_PLAYERS", Description: "Макс. игроков", Default: "20"},
				{Key: "ONLINE_MODE", Description: "Проверка лицензии", Default: "true", Options: []string{"true","false"}},
				{Key: "ALLOW_NETHER", Description: "Незер", Default: "true", Options: []string{"true","false"}},
				{Key: "PVP", Description: "PvP", Default: "true", Options: []string{"true","false"}},
			},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				{Key: "EULA", Description: "Принять EULA", Default: "TRUE", Required: true},
				{Key: "TYPE", Description: "Ядро: FORGE или FABRIC", Default: "FORGE", Options: []string{"PAPER","VANILLA","SPIGOT","FORGE","FABRIC","BUKKIT","PURPUR","AIRPLANE","MAGMA","MOHIST"}},
				{Key: "VERSION", Description: "Версия Minecraft", Default: "1.20.1", Options: []string{"LATEST","1.21","1.20.4","1.20.1","1.19.4","1.18.2","1.17.1","1.16.5","1.15.2","1.14.4","1.12.2","1.7.10"}},
				{Key: "JAVA_VERSION", Description: "Java: jdk8-jre до jdk25-jre", Default: "jdk21-jre", Options: []string{"jdk21-jre","jdk17-jre","jdk16-jre","jdk11-jre","jdk8-jre"}},
				...
				{Key: "DIFFICULTY", Description: "Сложность", Default: "hard", Options: []string{"easy","normal","hard","peaceful"}},
				{Key: "MODE", Description: "Режим игры", Default: "survival", Options: []string{"survival","creative","adventure","spectator"}},
				{Key: "MAX_PLAYERS", Description: "Макс. игроков", Default: "20"},
				{Key: "ENABLE_RCON", Description: "RCON доступ", Default: "true", Options: []string{"true","false"}},
				{Key: "ONLINE_MODE", Description: "Проверка лицензии", Default: "true", Options: []string{"true","false"}},
			},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				...
				{Key: "VERSION", Description: "MongoDB version", Default: "7", Options: []string{"7","6","5","4.4"}},
			},
		...
		},
		{
			...
			DefaultPort: "80",
			Env: []models.BlueprintEnv{
				{Key: "VERSION", Description: "PHP image version", Default: "8.2-apache", Options: []string{"8.2-apache","8.1-apache","8.0-apache","7.4-apache"}},
			},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				{Key: "VERSION", Description: "Go image version", Default: "1.22-alpine", Options: []string{"1.22-alpine","1.21-alpine","1.20-alpine","latest"}},
			},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				{Key: "VERSION", Description: "Rust image version", Default: "1.78-slim", Options: []string{"1.78-slim","1.77-slim","1.76-slim","latest-slim"}},
			},
		...
		},
		{
			...
			DefaultPort: "80",
			Env: []models.BlueprintEnv{
				{Key: "VERSION", Description: "WordPress version", Default: "6", Options: []string{"6","5.9","5.8"}},
		...
		},
		{
			...
			Env: []models.BlueprintEnv{
				{Key: "VERSION", Description: "Ubuntu version", Default: "24.04", Options: []string{"24.04","22.04","20.04"}},
			},
		...
		},
		{
			...
			DefaultCmd:  "sleep infinity",
			Env: []models.BlueprintEnv{
				{Key: "VERSION", Description: "Alpine version", Default: "3.20", Options: []string{"3.20","3.19","3.18","latest"}},
			},
		},
		{
