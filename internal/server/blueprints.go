...
func getBlueprints() []models.Blueprint {
	return []models.Blueprint{
		...
		},
		{
			...
			Description: "Java Edition Minecraft server. Supports Paper, Vanilla, Spigot, Forge, Fabric. Auto-detects Java version.",
			Category:    "Game",
			Icon:        "gamepad-2",
			...
			Env: []models.BlueprintEnv{
				...
				{Key: "TYPE", Description: "Server type: PAPER, VANILLA, SPIGOT, FORGE, FABRIC, BUKKIT", Default: "PAPER"},
				{Key: "VERSION", Description: "Minecraft version (e.g. 1.20.4, 1.16.5, LATEST)", Default: "LATEST"},
				{Key: "JAVA_VERSION", Description: "JDK: jdk21-jre (1.18+), jdk16-jre (1.12-1.17), jdk8-jre (older)", Default: "jdk21-jre"},
				{Key: "MEMORY", Description: "RAM allocation (e.g. 2G, 4G, 8G)", Default: "2G"},
				{Key: "DIFFICULTY", Description: "easy, normal, hard, peaceful", Default: "easy"},
				{Key: "MODE", Description: "survival, creative, adventure, spectator", Default: "survival"},
				{Key: "ENABLE_RCON", Description: "Enable RCON console access", Default: "true"},
			},
			EnvTips: "For old Minecraft versions (1.16.5 and below), set JAVA_VERSION=jdk16-jre or JAVA_VERSION=jdk8-jre. For modded (Forge/Fabric), set TYPE=FORGE or TYPE=FABRIC and VERSION to the desired version.",
			Volumes: []string{"mc_data:/data:world, configs, mods and plugins"},
		},
		{
			Name:        "Minecraft Vanilla",
			Description: "Official vanilla Minecraft server. Lightweight, no plugins, pure Mojang experience.",
			Category:    "Game",
			Icon:        "gamepad-2",
			Image:       "itzg/minecraft-server",
			DefaultPort: "25565",
			Env: []models.BlueprintEnv{
				...
				{Key: "TYPE", Description: "Server type", Default: "VANILLA"},
				{Key: "VERSION", Description: "Minecraft version", Default: "LATEST"},
				{Key: "JAVA_VERSION", Description: "JDK: jdk21-jre (1.18+), jdk16-jre (older)", Default: "jdk21-jre"},
				{Key: "MEMORY", Description: "RAM allocation", Default: "2G"},
				{Key: "DIFFICULTY", Description: "easy, normal, hard, peaceful", Default: "easy"},
				{Key: "MODE", Description: "survival, creative, adventure", Default: "survival"},
				{Key: "MAX_PLAYERS", Description: "Max online players", Default: "20"},
			},
			Volumes: []string{"mc_vanilla:/data:world and config files"},
		},
		{
			Name:        "Minecraft Modded (Forge)",
			Description: "Forge modded Minecraft server. Install mods and modpacks with full Forge compatibility.",
			Category:    "Game",
			Icon:        "gamepad-2",
			Image:       "itzg/minecraft-server",
			DefaultPort: "25565",
			Env: []models.BlueprintEnv{
				{Key: "EULA", Description: "Accept Mojang EULA", Default: "TRUE", Required: true},
				{Key: "TYPE", Description: "Server type", Default: "FORGE"},
				{Key: "VERSION", Description: "Minecraft version", Default: "1.20.1"},
				{Key: "JAVA_VERSION", Description: "JDK: jdk21-jre (1.18+), jdk17-jre (1.17)", Default: "jdk21-jre"},
				{Key: "MEMORY", Description: "RAM allocation (modded needs more)", Default: "4G"},
				{Key: "FORGEVERSION", Description: "Forge version (leave empty for latest)", Default: ""},
				{Key: "DIFFICULTY", Description: "Game difficulty", Default: "hard"},
				{Key: "MODE", Description: "Game mode", Default: "survival"},
				{Key: "ENABLE_RCON", Description: "Enable RCON", Default: "true"},
			},
			EnvTips: "Forge modded servers need more RAM. Start with 4G minimum. Place mod .jar files in /data/mods volume.",
			Volumes: []string{"mc_forge:/data:world, configs, mods and plugins"},
		},
		{
