...
func (s *Store) migrate() error {
	...
	if count == 0 {
		...
		s.db.Exec("INSERT OR IGNORE INTO settings (key, value) VALUES ('allow_user_images', 'false')")
		s.db.Exec("INSERT OR IGNORE INTO settings (key, value) VALUES ('allow_user_templates', 'false')")
		s.db.Exec("INSERT OR IGNORE INTO settings (key, value) VALUES ('allow_user_projects', 'false')")
		...
		s.db.Exec("INSERT OR IGNORE INTO settings (key, value) VALUES ('disabled_features', 'images,config,blueprints,projects,guide')")
