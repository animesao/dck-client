...
// Blueprints
const blueprints = [
  { name: 'Nginx Web Server', description: 'Lightweight web server for static content', category: 'web', image: 'nginx:latest', icon: 'web', env: [{ key: 'PORT', description: 'Port to expose', default: '80', required: false, placeholder: '80' }] },
  { name: 'Redis Cache', description: 'In-memory data store for caching', category: 'database', image: 'redis:latest', icon: 'database', env: [{ key: 'REDIS_PASSWORD', description: 'Redis password', default: '', required: false, advanced: true, placeholder: 'optional' }] },
  { name: 'PostgreSQL', description: 'Relational database', category: 'database', image: 'postgres:16', icon: 'database', env: [{ key: 'POSTGRES_PASSWORD', description: 'Database password', default: 'changeme', required: true, placeholder: 'Enter password' }, { key: 'POSTGRES_DB', description: 'Database name', default: 'mydb', required: false, placeholder: 'mydb' }] },
  ...
  { name: 'MongoDB', description: 'NoSQL document database', category: 'database', image: 'mongo:latest', icon: 'database', env: [{ key: 'MONGO_INITDB_ROOT_USERNAME', description: 'Root username', required: false, placeholder: 'admin' }, { key: 'MONGO_INITDB_ROOT_PASSWORD', description: 'Root password', required: true, placeholder: 'Enter password' }] },
  { name: 'Node.js App', description: 'Node.js application runtime', category: 'runtime', image: 'node:22', icon: 'runtime', env: [{ key: 'NODE_ENV', description: 'Environment', default: 'production', options: ['development', 'production', 'test'], required: false }, { key: 'PORT', description: 'App port', default: '3000', required: false, placeholder: '3000' }] },
  { name: 'Python App', description: 'Python application runtime', category: 'runtime', image: 'python:3.12', icon: 'runtime', env: [{ key: 'PYTHONUNBUFFERED', description: 'Python unbuffered output', default: '1', required: false, placeholder: '1' }] },
  { name: 'Discord Bot (Python)', description: 'Discord bot template with discord.py', category: 'bot', image: 'python:3.12', icon: 'bot', env: [{ key: 'DISCORD_TOKEN', description: 'Discord bot token', default: '', required: true, placeholder: 'Enter your bot token' }, { key: 'PREFIX', description: 'Command prefix', default: '!', required: false, placeholder: '!' }] },
  { name: 'Discord Bot (Node.js)', description: 'Discord bot template with discord.js', category: 'bot', image: 'node:22', icon: 'bot', env: [{ key: 'DISCORD_TOKEN', description: 'Discord bot token', default: '', required: true, placeholder: 'Enter your bot token' }, { key: 'CLIENT_ID', description: 'Discord client ID', required: false, placeholder: 'Enter client ID' }] },
  ...
  { name: 'Alpine Linux', description: 'Minimal Linux distribution for testing', category: 'tool', image: 'alpine:latest', icon: 'tool', env: [] },
  { name: 'Ubuntu', description: 'Full Linux distribution', category: 'tool', image: 'ubuntu:latest', icon: 'tool', env: [] },
]
